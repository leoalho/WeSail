...
const Owner = ({applications, acceptCrewRequest, rejectCrewRequest, boat, setBoat}: Props) => {
  ...
  const addOwner = async () => {
    const patches: Patch[] = []
    selectedUsers.forEach(selectedUser => patches.push({op: "add", path: "/owners", value: selectedUser.value}))
