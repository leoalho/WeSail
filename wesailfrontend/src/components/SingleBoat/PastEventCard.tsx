...
const PastEventCard = ({event, boatId}: Props) => {
    ...
    const createLog = () => {
        navigate("/newLog", {state: {boat: boatId, participants: event.participants.map(participant =>{ return {value: participant.id, label: participant.username}}),
