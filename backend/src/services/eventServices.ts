...
export const addToEventArray = async (
  id: string,
  field: EventArray,
  value: string
) => {
...
export const removeFromEventArray = async (
  id: string,
  field: EventArray,
  value: string
) => {
